...
void CharacterKoopa::Render()
{
	...
	// {xPos, yPos, width of the sprite , height of the sprite}
...
void CharacterKoopa::CheckForBounderies() 
{
	//Change direction when hit the border
...
Rect2D CharacterKoopa::GetHeadCollisionBox()
{
	Rect2D headCollisionBox = 
	{
		...
		5.0f // Height of the head collision box as float
	};
